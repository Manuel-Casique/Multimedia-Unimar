    ...
    public function run(): void
    {
        ...
        $publications = [
            [
                ...
                'excerpt' => 'El rector da la bienvenida a los nuevos estudiantes de la Universidad de Margarita.',
            ...
            [
                ...
                'excerpt' => 'Estudiantes de enfermería realizan jornada de salud para toda la comunidad unimarista.',
            ...
            [
                ...
                'excerpt' => 'Descubre cómo la IA está cambiando la forma de aprender y enseñar en la actualidad.',
            ...
            [
                ...
                'excerpt' => 'Revive los mejores momentos de la última ceremonia de graduación.',
            ...
            [
                ...
                'excerpt' => 'Preparativos para el próximo torneo deportivo.',
        ...
        foreach ($publications as $pubData) {
            ...
            foreach ($randomCategories as $categoryId) {
                DB::table('category_publication')->insert([
            ...
            // Assign a random location occasionally
            if ($locations->count() > 0 && rand(0, 1) === 1) {
                DB::table('location_publication')->insert([
                    'publication_id' => $pubId,
